...
// Res:
character.age = 25;
console.log('Edad cambiada: ', character.age);
...
// Res:
console.log('Precio de los juguetes: ', toy1.price + toy2.price);
...
console.log('Precio final del coche1: ', car1.finalPrice);
car2.finalPrice = car2.basePrice + globalBasePrice;
console.log('Precio final del coche2: ', car2.finalPrice);
